...
///
/// When used as [CupertinoTabScaffold.tabBar], by default `AppTabBar` has
...
/// with the desired [MediaQueryData.textScaler] value. The text scale factor
/// value from the operating system can be retrieved in many ways, such as querying
/// [MediaQuery.textScaler] against [CupertinoApp]'s [BuildContext].
///
/// See also:
///
///  * [CupertinoTabScaffold], which hosts the [AppTabBar] at the bottom.
///  * [BottomNavigationBarItem], an item in a [AppTabBar].
class AppTabBar extends StatelessWidget implements PreferredSizeWidget {
              ...
              child: Semantics(
                ...
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                      if (sidebar?.header != null) sidebar!.header!,
                      Expanded(
                        child: ListView(
                          padding: sidebar?.menuPadding,
                          shrinkWrap: true,
                          children: _buildTabItems(context),
                        ),
                      ),
                      if (sidebar?.bottom != null) sidebar!.bottom!,
                    ],
                  ),
                ),
              ),
          ...
          _wrapActiveItem(
            ...
            Semantics(
              ...
              child: Column(
                ...
                children: _buildHorizontalTabItem(
                    items[index],
                    active,
                    onTap == null
                        ? null
  ...
  List<Widget> _buildHorizontalTabItem(
  ...
  /// Create a clone of the current [AppTabBar] but with provided
...
class AppSidebar {
  ...
  final Widget? bottom;
  AppSidebar({this.bottom, this.header, this.menuPadding = EdgeInsets.zero});
}
